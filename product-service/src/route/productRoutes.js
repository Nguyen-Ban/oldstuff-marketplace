...
router.post('/create', authenticate, uploadCloud.single('image'), productController.createProduct);
...
router.put('/update/:id', authenticate, uploadCloud.single('image'), productController.updateProduct);
